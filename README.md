...
Sou Desenvolvedor Front-End em início de carreira, estudante de Engenharia de Software, com foco na criação de interfaces modernas, responsivas e acessíveis.  
Possuo experiência prática em projetos utilizando HTML, CSS, JavaScript, TypeScript e React, sempre aplicando boas práticas de desenvolvimento, usabilidade e organização de código.
